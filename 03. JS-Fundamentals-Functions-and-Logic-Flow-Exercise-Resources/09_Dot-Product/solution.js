function solve() {
    ...
    let paraf1 = document.createElement('p');
    let paraf2 = document.createElement('p');
    //let paraf3 = document.createElement('p');
    //let paraf4 = document.createElement('p');
    paraf1.textContent = `${product1}, ${product2}`
    paraf2.textContent = `${product3}, ${product4}`
    //paraf3.textContent = product3;
    //paraf4.textContent = product4;
    result.appendChild(paraf1)
    result.appendChild(paraf2)
    //result.appendChild(paraf3)
    //result.appendChild(paraf4)
